...
export default function RegisterReceptionist({ navigation }) {
  ...
  const handleRegister = async () => {
    ...
    setLoading(true);
    const result = await register({ name, email, password, role: 'receptionist' });
    setLoading(false);
      ...
      >
        <ScrollView contentContainerStyle={styles.scroll}>
          <View style={styles.card}>
            <Ionicons name="call-outline" size={60} color="#fff" style={styles.icon} />
            <Text style={styles.headerText}>Register as Receptionist</Text>
